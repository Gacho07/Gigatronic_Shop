<main>
    ...
    <!-- Start of separated products from database -->
    <div id="separatedProducts">
                    ...
                    ?>
                        <div class="mx-auto col-md-6 col-lg-3 my-3">
                            <div class="featured-container p-5">
                                ...
                                <button name="view" value="View" id=<?= $aF->idArticle ?> class="view_data">
    ...
    <!-- End of separated products from database -->
