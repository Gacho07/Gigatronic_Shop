<div class="row">
    <div class="col-md-6 mx-auto">
        ...
        <form method="POST" action="">
            ...
            <input type="button" value="Insert" name="btnAddPoll" id="btnAddPoll" class="btn btn-success">
            <div id="errorsPoll">
            ...
            <input type="button" value="Save" name="btnActivatePoll" id="btnActivatePoll" class="btn btn-success">
            <div id="activatePoll">
            ...
            <input type="button" value="Show" name="btnPollResult" id="btnPollResult" class="btn btn-success">
